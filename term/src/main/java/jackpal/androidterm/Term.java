...
public class Term extends Activity implements UpdateCallback {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.term_main, menu);
...
//        MenuItemCompat.setShowAsAction(menu.findItem(R.id.menu_float_window), MenuItemCompat.SHOW_AS_ACTION_IF_ROOM);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu_preferences) {
            ...
            doToggleWifiLock();
        } else if (id == R.id.menu_float_window) {
            mTermService.createFloatView();
//            LinearLayout floatLayout = (LinearLayout) LayoutInflater.from(getApplication()).inflate(R.layout.float_layout, null);
            finish();
